          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-32 items-start">
             <div className="corp-reveal">
                ...
                <p className="text-corporate-body text-primary! mt-12 mb-16 leading-relaxed max-w-xl">
                  Für Einkaufabteilungen und Sicherheitsverantwortliche garantieren wir volle Audit-Readiness. Die Topgun Security ist seit Anfang des Jahres nach <span className="font-bold underline decoration-accent underline-offset-4">DIN 77200</span> und <span className="font-bold underline decoration-accent underline-offset-4">ISO 9001</span> zertifiziert.
                </p>
             ...
             <div className="corp-reveal pt-12">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                   <div className="border border-primary/10 p-10">
                      <div className="w-12 h-1 bg-accent mb-8" />
                      <h4 className="text-primary font-black text-sm tracking-widest uppercase mb-4">DIN 77200</h4>
                   ...
                   <div className="border border-primary/10 p-10">
                      ...
                      <h4 className="text-primary font-black text-sm tracking-widest uppercase mb-4">ISO 9001</h4>
